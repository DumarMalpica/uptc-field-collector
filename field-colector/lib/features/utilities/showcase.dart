          ...
          children: [
            ...
            Wrap(
              ...
              children: [
                ...
                _colorChip('cumulusBlue (mint)', AppColors.cumulusBlue),
                _colorChip('wildYellow (ámbar)', AppColors.wildYellow),
                _colorChip('cloudWhite (crema)', AppColors.cloudWhite),
                _colorChip('primary', AppColors.primary),
                _colorChip('secondary', AppColors.secondary),
                _colorChip('accent', AppColors.accent),
                _colorChip('semilleroDeepBlue', AppColors.semilleroDeepBlue),
                _colorChip('semilleroViolet', AppColors.semilleroViolet),
                _colorChip('error', AppColors.error),
                _colorChip('errorText', AppColors.errorText),
              ],
            ),

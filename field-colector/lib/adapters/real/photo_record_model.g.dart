...
part of 'photo_record_model.dart';
...
const PhotoRecordSchema = Schema(
  name: r'PhotoRecord',
...
void _photoRecordSerialize(
  ...
  writer.writeString(offsets[3], object.photoType);
  writer.writeString(offsets[4], object.recordId);
  writer.writeString(offsets[5], object.recordType);
  writer.writeString(offsets[6], object.storageUrl);
...
PhotoRecord _photoRecordDeserialize(
  ...
  object.photoType = reader.readString(offsets[3]);
  object.recordId = reader.readString(offsets[4]);
  object.recordType = reader.readString(offsets[5]);
  object.storageUrl = reader.readString(offsets[6]);
...
extension PhotoRecordQueryFilter
  ...
  QueryBuilder<PhotoRecord, PhotoRecord, QAfterFilterCondition> filenameEqualTo(
    String value, {
  ...
  QueryBuilder<PhotoRecord, PhotoRecord, QAfterFilterCondition> filenameBetween(
    String lower,
    String upper, {
  ...
  QueryBuilder<PhotoRecord, PhotoRecord, QAfterFilterCondition> filenameMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<PhotoRecord, PhotoRecord, QAfterFilterCondition> idStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<PhotoRecord, PhotoRecord, QAfterFilterCondition> idEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<PhotoRecord, PhotoRecord, QAfterFilterCondition> idContains(
      String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.contains(
  ...
  QueryBuilder<PhotoRecord, PhotoRecord, QAfterFilterCondition> idMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.matches(
  ...
  QueryBuilder<PhotoRecord, PhotoRecord, QAfterFilterCondition> idIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'id',
        value: '',
  ...
  QueryBuilder<PhotoRecord, PhotoRecord, QAfterFilterCondition> idIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.greaterThan(
        property: r'id',
        value: '',
  ...
  QueryBuilder<PhotoRecord, PhotoRecord, QAfterFilterCondition>
      photoTypeContains(String value, {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.contains(
        property: r'photoType',
        value: value,
  ...
  QueryBuilder<PhotoRecord, PhotoRecord, QAfterFilterCondition>
      photoTypeMatches(String pattern, {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.matches(
        property: r'photoType',
        wildcard: pattern,
  ...
  QueryBuilder<PhotoRecord, PhotoRecord, QAfterFilterCondition> recordIdEqualTo(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<PhotoRecord, PhotoRecord, QAfterFilterCondition> recordIdBetween(
    String lower,
    String upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<PhotoRecord, PhotoRecord, QAfterFilterCondition> recordIdMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.matches(

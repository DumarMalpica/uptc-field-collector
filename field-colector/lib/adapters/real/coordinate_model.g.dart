...
const CoordinateModelSchema = Schema(
  ...
  properties: {
    ...
    r'manuallyEdited': PropertySchema(
      id: 4,
      name: r'manuallyEdited',
      type: IsarType.bool,
    )
  },
...
void _coordinateModelSerialize(
  ...
  writer.writeDouble(offsets[1], object.gpsAccuracy);
  writer.writeDouble(offsets[2], object.latitude);
  writer.writeDouble(offsets[3], object.longitude);
  writer.writeBool(offsets[4], object.manuallyEdited);
}
...
CoordinateModel _coordinateModelDeserialize(
  ...
  object.gpsAccuracy = reader.readDouble(offsets[1]);
  object.latitude = reader.readDouble(offsets[2]);
  object.longitude = reader.readDouble(offsets[3]);
  object.manuallyEdited = reader.readBool(offsets[4]);
  return object;
}
...
extension CoordinateModelQueryFilter
  ...
  QueryBuilder<CoordinateModel, CoordinateModel, QAfterFilterCondition>
      manuallyEditedEqualTo(bool value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'manuallyEdited',
        value: value,
      ));
    });
  }
